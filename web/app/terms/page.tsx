export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      <h1 className="text-title tracking-tight text-brand-text-primary mb-2">Terms of Service</h1>
      ...
      <div className="space-y-8 text-brand-text-secondary text-body leading-relaxed">
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">1. Agreement</h2>
        ...
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">2. Use of the App</h2>
        ...
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">3. User Content</h2>
        ...
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">4. Privacy</h2>
          <p>Your use of the App is also governed by our <a href="/privacy" className="underline underline-offset-2 hover:text-brand-primary transition-colors">Privacy Policy</a>, which is incorporated into these Terms.</p>
        </section>

        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">5. Termination</h2>
        ...
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">6. Disclaimers</h2>
        ...
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">7. Changes</h2>
        ...
        <section>
          <h2 className="text-[10px] font-semibold tracking-widest uppercase text-brand-text-primary mb-3">8. Contact</h2>
          <p>For questions about these Terms, contact us at <a href="mailto:support@aitrove.ai" className="underline underline-offset-2 hover:text-brand-primary transition-colors">support@aitrove.ai</a>.</p>
        </section>
      </div>

      <div className="mt-12 pt-8 border-t border-brand-divider text-[11px] tracking-widest uppercase text-brand-text-muted">
        Pathvana LLC · <a href="/privacy" className="hover:text-brand-primary transition-colors">Privacy Policy</a>
      </div>
    </div>
  )
}
