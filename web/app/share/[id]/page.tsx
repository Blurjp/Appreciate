        ...
        <div className="bg-white rounded-3xl border border-brand-border overflow-hidden">
          ...
          <div className="p-8">
            <div className="flex items-center justify-center gap-1.5 mb-8">
              ...
              <span className="text-xs tracking-widest uppercase font-semibold text-brand-text-muted">Appreciate</span>
            </div>
            ...
            <blockquote className="text-center text-brand-text-primary text-lg font-medium leading-relaxed mb-4">
              &ldquo;{post.content}&rdquo;
            </blockquote>

            {post.feeling && (
              <p className="text-center text-sm text-brand-text-muted italic mb-4">
            ...
            {post.heartCount > 0 && (
              <div className="flex items-center justify-center gap-1 mb-4">
                ...
                <span className="text-sm text-brand-text-muted">{post.heartCount}</span>
              </div>
            )}

            <div className="h-px bg-brand-divider my-5" />
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold text-brand-text-secondary truncate">{authorName}</p>
                <p className="text-xs text-brand-text-muted">{date}</p>
              </div>
            </div>
          </div>

          <div className="px-8 py-5 bg-brand-surface border-t border-brand-divider text-center">
            <p className="text-xs text-brand-text-muted mb-2">Share your own gratitude</p>
...
function PrivateCard({ signupHref }: { signupHref: string }) {
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-brand-surface">
      <div className="bg-white rounded-3xl border border-brand-border p-10 max-w-sm w-full text-center">
        <div className="w-14 h-14 rounded-full bg-brand-surface flex items-center justify-center mx-auto mb-4">
          <svg className="w-7 h-7 text-brand-text-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          </svg>
        </div>
        <h2 className="text-title-3 text-brand-text-primary mb-2">Private Appreciation</h2>
        <p className="text-subheadline text-brand-text-muted mb-6">This moment of gratitude is kept private by its author.</p>
        <div className="flex flex-col gap-3">
          <a
            href={signupHref}
            className="inline-block px-5 py-3 rounded-full bg-brand-primary text-white text-subheadline font-semibold tracking-wide"
          >
            Sign up for Appreciate
          </a>
          <a
            href="https://appreciate.live"
            className="inline-block px-5 py-3 rounded-full border border-brand-border text-brand-text-secondary text-subheadline font-semibold tracking-wide"
          >
