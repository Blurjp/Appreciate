        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-2xl p-6 mx-6 max-w-sm w-full animate-fade-in border border-brand-border">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white rounded-xl text-body text-[#211713] placeholder:text-[#6B5E57] focus:outline-none focus:ring-1 focus:ring-brand-primary border border-brand-border mb-4"
