          ...
          <form onSubmit={handleCredentialAuth} className="space-y-3">
            {isSignUp && (
              <input
                ...
                className="w-full px-4 py-3 bg-white rounded-xl text-body text-[#211713] placeholder:text-[#6B5E57] focus:outline-none focus:ring-1 focus:ring-brand-primary border border-brand-border"
                required
              />
            )}
            <input
