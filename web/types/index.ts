...
export const CATEGORIES: {
...
}[] = [
  {
    ...
    emoji: '♡',
    color: '#9B4D30',
    gradient: 'linear-gradient(135deg, #B86545 0%, #9B4D30 100%)',
  },
  {
    value: 'WORK',
    label: 'Work',
  ...
  },
  {
    ...
    emoji: '◇',
    color: '#7A6023',
    gradient: 'linear-gradient(135deg, #9A7A2D 0%, #7A6023 100%)',
  },
  {
    value: 'NATURE',
    label: 'Nature',
    emoji: '◉',
    color: '#566747',
    gradient: 'linear-gradient(135deg, #6E815D 0%, #566747 100%)',
  },
  {
    value: 'HEALTH',
    label: 'Health',
    emoji: '○',
    color: '#6E5877',
    gradient: 'linear-gradient(135deg, #887091 0%, #6E5877 100%)',
  },
  {
    value: 'OTHER',
    label: 'Other',
    emoji: '·',
    color: '#655446',
    gradient: 'linear-gradient(135deg, #806B59 0%, #655446 100%)',
  },
]
